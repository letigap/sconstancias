...
try {
    ...
    $mail->Host       = 'smtp.depfe.economia.unam.mx';  // Specify main and backup SMTP servers
    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    $mail->Username   = 'supervisor@depfe.economia.unam.mx';                     // SMTP username
    $mail->Password   = 'Spira2015/';                               // SMTP password
    $mail->SMTPSecure = 'tls';                                  // Enable TLS encryption, `ssl` also accepted
    $mail->Port       = 25;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('supervisor@depfe.unam.mx', 'Letiga');
